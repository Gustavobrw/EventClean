...
public class EventoController {
    ...
    private final FiltrarIdentificadorEventoUseCase filtrarIdentificadorEvento;
    private final EventoDtoMapper eventoDtoMapper;

    public EventoController(CriarEventoUseCase criarEventoUseCase, BuscarEventoUseCase buscarEventoUseCase, BuscarEventoPorIdUseCase buscarEventoPorIdUseCase, FiltrarIdentificadorEventoUseCase filtrarIdentificadorEvento, EventoDtoMapper eventoDtoMapper) {
        this.criarEventoUseCase = criarEventoUseCase;
        this.buscarEventoUseCase = buscarEventoUseCase;
        this.buscarEventoPorIdUseCase = buscarEventoPorIdUseCase;
        this.filtrarIdentificadorEvento = filtrarIdentificadorEvento;
        this.eventoDtoMapper = eventoDtoMapper;
    }

    @PostMapping("criarevento")
    public ResponseEntity<Map<String, Object>> criarEvento(@RequestBody EventoRequestDto eventoDto) {
    ...
    @GetMapping("filtrarevento/{identificador}")
    public ResponseEntity<EventoDto> filtrarIdentificadorEvento(@PathVariable String identificador) {
        Evento evento = filtrarIdentificadorEvento.execute(identificador);
